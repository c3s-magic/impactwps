...
export PYWPS_PROCESSES=/usr/people/mihajlov/python/clipc/impactportalwpsscripts
...
export POF_OUTPUT_PATH=/usr/people/mihajlov/python/clipc/impactportalwpsscripts
